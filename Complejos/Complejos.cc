...
int main() {
    int RC1, RC2, IC1, IC2;
    std::cout << "Dime el numero complejo nº1, su parte real y su parte imaginaria: " << std::endl;
    std::cin >> RC1 >> IC1;
    std::cout << "Dime el numero complejo nº2, su parte real y su parte imaginaria: " << std::endl;
    std::cin >> RC2 >> IC2;
